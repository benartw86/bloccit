...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST create" do
    it "increases the number of Question by 1" do
      expect{post :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph}}
    end
 ...
 describe "GET #show" do
  ...
  it "assigns questions to be updated to @question" do
    get :edit, {id: my_question.id}
  ...
  describe "PUT update" do
    it "updates the question to reflect changes to attributes" do
     ...
     it "redirects to the new updated question" do
       new_title = RandomData.random_sentence
       new_body = RandomData.random_paragraph
